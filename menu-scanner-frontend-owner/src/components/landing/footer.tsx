  ...
  return (
    <footer className="bg-card border-t border-border">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          ...
          <div>
            ...
            <p className="text-base text-muted-foreground leading-relaxed mb-5">
              Smart Digital Menus for Cambodian Restaurants. Go paperless,
              serve faster, grow smarter.
            </p>
            {/* Social icons */}
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-3 text-base text-muted-foreground">
          <span>© 2025 EMenu Cambodia. All rights reserved.</span>
