        ...
        <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-20">
          ...
          <div className="flex-1 lg:py-28">
            <FadeIn direction="up" delay={0}>
              ...
              >
                🇰🇭 Built for Every Business in Cambodia
              </Badge>

              <h1 className="text-7xl sm:text-8xl font-extrabold text-slate-900 leading-[1.05] mt-6 tracking-tight">
                Run Your Business.<br />
                <span className="text-primary">Fully Digital.</span>
              </h1>

              <p className="text-xl text-slate-500 mt-6 max-w-lg leading-relaxed">
                EMenu Cambodia gives restaurants, cafés, and food businesses a complete
                digital platform — QR menus, real-time POS, e-commerce, Telegram bot,
                and powerful analytics. All in one. All free.
              </p>
            ...
            <FadeIn direction="up" delay={300}>
              <div className="flex items-center gap-5 mt-10 pt-8 border-t border-slate-100">
                ...
                <p className="text-base text-slate-500">
                  <span className="font-semibold text-slate-900">Businesses across Cambodia</span> — restaurants, cafés & more
                </p>
              </div>
            </FadeIn>
          </div>
