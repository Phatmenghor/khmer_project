...
export default function SubscriptionActionModal({
  ...
  const cancelForm = useForm<CancelSubscriptionData>({
    ...
    defaultValues: { reason: "", notes: "", refundAmount: 0, refundMethod: "", refundReference: "" },
  });
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div className="md:col-span-2">
                          <TextField
                            ...
                            placeholder="Optional notes"
                            disabled={isSubmitting}
                            error={getFieldError(cancelForm.formState.errors.notes)}
                          />
                        </div>
                      </div>
                      <div className="flex justify-end gap-3 pt-2">
                    ...
                    <table className="w-full text-sm">
                      ...
                      <tbody>
                        {subscriptionHistory.map((row, idx) => (
                          <tr key={row.subscriptionId} className="border-b last:border-0 hover:bg-muted/20 transition-colors">
