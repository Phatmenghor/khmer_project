...
import com.emenu.features.master.repository.SubscriptionPaymentRepository;
...
import com.emenu.features.master.mapper.SubscriptionHistoryMapper;
import com.emenu.features.master.service.SubscriptionService;
...
public class SubscriptionServiceImpl implements SubscriptionService {
    ...
    private SubscriptionHistoryResponse toHistoryResponse(Subscription subscription) {
        ...
        if (response != null && subscription != null) {
            response.setInvoiceNumber(SubscriptionPdfReceiptGenerator.formatInvoiceNumber(subscription));
