...
public class OrderProcessStatusServiceImpl implements OrderProcessStatusService {
    ...
    public PaginationResponse<OrderProcessStatusResponse> getAllOrderProcessStatuses(OrderProcessStatusFilterRequest filter) {
        ...
        Specification<OrderProcessStatus> spec = OrderProcessStatusSpecification.filterOrderProcessStatuses(
                filter.getBusinessId(),
                statuses,
                filter.getSearch()
        );

        Page<OrderProcessStatus> page = orderProcessStatusRepository.findAll(spec, pageable);
