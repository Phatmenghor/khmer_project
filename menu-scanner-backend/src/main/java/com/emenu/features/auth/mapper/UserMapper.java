...
public interface UserMapper {
    ...
    @Mapping(target = "profileImageSmUrl", source = "profile.profileImageSmUrl")
    @Mapping(target = "profileImageLgUrl", source = "profile.profileImageLgUrl")
    @Mapping(target = "profileImageOUrl",  source = "profile.profileImageOUrl")
