...
public interface BusinessOwnerMapper {
    ...
    @Mapping(target = "subscriptionStartDate", expression = "java(subscription.getStartDate() != null ? subscription.getStartDate().toLocalDate() : null)")
    @Mapping(target = "subscriptionEndDate", expression = "java(subscription.getEndDate() != null ? subscription.getEndDate().toLocalDate() : null)")
