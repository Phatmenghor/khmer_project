-- ============================================================================
-- V6: Regenerate Test Data with Updated Pricing Fields
-- Purpose: Clear old orders and generate fresh test data with new pricing schema
-- - discountAmount (instead of totalDiscount)
-- - hasActivePromotion, promotionType, promotionValue
-- ============================================================================

-- Clear existing order data (in reverse order of foreign key dependencies)
...
-- ============================================================================
-- Re-initialize order counters for businesses (per-business sequences)
-- ============================================================================
...
-- ============================================================================
-- ORDER ITEMS (1000 items: 5 per order × 200 orders)
-- ============================================================================
...
SELECT
    ...
    CASE WHEN (o.rn % 4) = 0 THEN CASE WHEN (o.rn % 6) = 0 THEN 'Out of stock, substituted'
                                        ...
                                        ELSE 'Kitchen recommendation' END ELSE NULL END
