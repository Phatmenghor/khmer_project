...
SELECT
    ...
    FALSE,
    '550cad56-cafd-4aba-baef-c4dcd53940d0'::uuid,
    (SELECT id FROM categories WHERE business_id = '550cad56-cafd-4aba-baef-c4dcd53940d0'::uuid ORDER BY RANDOM() LIMIT 1)::uuid,
    (SELECT id FROM brands ORDER BY RANDOM() LIMIT 1)::uuid,
    'Product ' || i::text,
...
SELECT
    ...
    NULL,
    FALSE,
    (SELECT id FROM orders WHERE source = 'PUBLIC' ORDER BY id LIMIT 1 OFFSET ((i-1) / 3))::uuid,
    (SELECT id FROM products WHERE business_id = '550cad56-cafd-4aba-baef-c4dcd53940d0'::uuid ORDER BY RANDOM() LIMIT 1)::uuid,
    NULL,
...
SELECT
    ...
    NULL,
    FALSE,
    (SELECT id FROM orders WHERE source = 'POS' ORDER BY id LIMIT 1 OFFSET ((i-1) / 3))::uuid,
