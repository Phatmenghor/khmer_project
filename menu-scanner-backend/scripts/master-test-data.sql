...
-- 1. ROLES
-- ============================================================================
INSERT INTO roles (id,  created_at, updated_at, created_by, updated_by, is_deleted, deleted_at, deleted_by, name, description, business_id, user_type) VALUES
...
-- 2. MAIN BUSINESS
-- ============================================================================
INSERT INTO businesses (id,  created_at, updated_at, created_by, updated_by, is_deleted, name, email, phone, address, description, owner_id, status, is_subscription_active) VALUES
...
-- 3. THREE MAIN USERS
-- ============================================================================
INSERT INTO users (id,  created_at, updated_at, created_by, updated_by, is_deleted, user_identifier, email, password, first_name, last_name, phone_number, profile_image_url, user_type, account_status, business_id, position, address, notes) VALUES
...
-- ============================================================================
INSERT INTO users (id,  created_at, updated_at, created_by, updated_by, is_deleted, user_identifier, email, password, first_name, last_name, phone_number, profile_image_url, user_type, account_status, business_id, position, address, notes)
SELECT
    gen_random_uuid(),
    0,
    NOW(),
...
-- ============================================================================
INSERT INTO categories (id,  created_at, updated_at, created_by, updated_by, is_deleted, business_id, name, image_url, status)
SELECT
    gen_random_uuid(),
    0,
    NOW(),
...
-- ============================================================================
INSERT INTO brands (id,  created_at, updated_at, created_by, updated_by, is_deleted, business_id, name, description, image_url, status)
SELECT
    gen_random_uuid(),
    0,
    NOW(),
