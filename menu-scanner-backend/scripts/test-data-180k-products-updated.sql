...
-- UPDATED FOR OrderStatus ENUM (No more OrderProcessStatus entity)
-- ============================================================================
...
BEGIN
    ...
    -- CLEANUP (removed order_process_statuses table)
    ...
    -- 180,000 PRODUCTS (25% with promotions, mixed types)
    ...
    -- ORDERS (NOW USING order_status ENUM instead of order_process_status_name)
    RAISE NOTICE 'Creating 200,000 orders with OrderStatus enum...';
    ...
    -- ORDER STATUS HISTORY (NOW USING order_status ENUM)
    RAISE NOTICE 'Creating order status history with OrderStatus enum...';
...
-- ============================================================================
-- COMPREHENSIVE PRODUCTION INDEXES - FULL INDEX SUITE (UPDATED)
-- ============================================================================
SELECT '✅ Dropping and recreating 90+ production indexes...' as status;
...
DROP INDEX IF EXISTS idx_products_has_active_promotion;
DROP INDEX IF EXISTS idx_products_business_category;
DROP INDEX IF EXISTS idx_products_promotion;
DROP INDEX IF EXISTS idx_products_created_at;
DROP INDEX IF EXISTS idx_products_updated_at;
DROP INDEX IF EXISTS idx_products_list_optimize;
DROP INDEX IF EXISTS idx_products_search;
DROP INDEX IF EXISTS idx_products_active_promotions;
DROP INDEX IF EXISTS idx_product_images_product_id;
DROP INDEX IF EXISTS idx_product_images_product_batch;
DROP INDEX IF EXISTS idx_product_sizes_product_id;
DROP INDEX IF EXISTS idx_product_sizes_product_active;
DROP INDEX IF EXISTS idx_product_favorites_user_id;
DROP INDEX IF EXISTS idx_product_favorites_product_id;
DROP INDEX IF EXISTS idx_product_favorites_user_product;
DROP INDEX IF EXISTS idx_carts_user_id;
DROP INDEX IF EXISTS idx_carts_business_id;
DROP INDEX IF EXISTS idx_carts_user_business;
DROP INDEX IF EXISTS idx_cart_items_cart_id;
DROP INDEX IF EXISTS idx_cart_items_product_id;
DROP INDEX IF EXISTS idx_cart_items_cart_product_size;
DROP INDEX IF EXISTS idx_orders_business_id;
DROP INDEX IF EXISTS idx_orders_customer_id;
DROP INDEX IF EXISTS idx_orders_business_customer;
DROP INDEX IF EXISTS idx_orders_status;
DROP INDEX IF EXISTS idx_orders_business_status;
...
DROP INDEX IF EXISTS idx_delivery_options_business_id;
DROP INDEX IF EXISTS idx_banners_business_id;
...
DROP INDEX IF EXISTS idx_attendances_business_id;
DROP INDEX IF EXISTS idx_attendances_date;
DROP INDEX IF EXISTS idx_attendances_reference;
DROP INDEX IF EXISTS idx_attendance_check_ins_attendance_id;
DROP INDEX IF EXISTS idx_work_schedules_user_id;
DROP INDEX IF EXISTS idx_work_schedules_business_id;
DROP INDEX IF EXISTS idx_work_schedules_schedule_type;
DROP INDEX IF EXISTS idx_roles_business_id;
DROP INDEX IF EXISTS idx_roles_user_type;
...
-- ORDERS (UPDATED FOR order_status ENUM)
...
CREATE INDEX idx_orders_business_status ON orders(business_id, order_status) WHERE is_deleted = false;
...
CREATE INDEX idx_orders_analytics ON orders(business_id, created_at, payment_status, order_status) WHERE is_deleted = false;
CREATE INDEX idx_orders_pending ON orders(business_id, created_at DESC) WHERE is_deleted = false AND order_status IN ('PENDING', 'CONFIRMED', 'PREPARING', 'READY', 'IN_TRANSIT');
...
-- ORDER STATUS HISTORY (NEW INDEXES FOR ENUM-BASED SYSTEM)
CREATE INDEX idx_order_status_history_order_id ON order_status_history(order_id) WHERE is_deleted = false;
CREATE INDEX idx_order_status_history_status ON order_status_history(order_status) WHERE is_deleted = false;
...
SELECT '🚀 180K products + OrderStatus enum + 90+ indexes ready!' as ready;
