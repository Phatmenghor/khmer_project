...
export function OrderSuccessModal({
  ...
  return (
    ...
    >
      ...
      {/* Action Buttons — Standard Proportions (h-9 / 36px) */}
      <div className="p-4 pt-2 flex flex-col gap-2">
        ...
        <div className="grid grid-cols-2 gap-2 w-full">
          <CustomButton
            ...
            variant="outline"
            size="sm"
            className="gap-2 h-9 text-xs font-semibold rounded-xl border-border/80 hover:bg-muted/50 transition-all duration-200 cursor-pointer"
        ...
        <CustomButton
          ...
          variant="ghost"
          size="sm"
          className="w-full h-9 text-xs font-semibold text-muted-foreground hover:text-foreground rounded-xl transition-all duration-200 cursor-pointer"
        >
          Continue Shopping
        </CustomButton>
      </div>
