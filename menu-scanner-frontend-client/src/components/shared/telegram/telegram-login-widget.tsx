...
export function TelegramLoginButton({
  ...
  return (
    <button
      ...
      className={`inline-flex items-center justify-center gap-1 rounded bg-[#0088cc] px-3 py-1 text-white font-medium transition-all hover:bg-[#0077b3] disabled:opacity-50 disabled:cursor-not-allowed ${className}`}
    >
      {loading ? (
