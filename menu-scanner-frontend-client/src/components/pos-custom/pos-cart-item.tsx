...
export function POSCartItem({
  ...
  return (
    <div className="bg-white border border-slate-200 rounded-xl p-4 hover:shadow-md transition-all duration-200 flex gap-3">
      {/* Edit Button - Always Visible on Left */}
      <CustomButton
        size="icon"
        variant="outline"
