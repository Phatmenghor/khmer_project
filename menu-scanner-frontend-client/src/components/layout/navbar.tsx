...
export function Navbar() {
  ...
  // DEBUG: Log navbar initialization
  useEffect(() => {
    console.log('## NAVBAR: Component mounted');
    console.log('## NAVBAR: isMounted =', isMounted);
    console.log('## NAVBAR: businessName =', businessName);
    console.log('## NAVBAR: primaryColor =', primaryColor);
    const bgColor = getComputedStyle(document.body).backgroundColor;
    console.log('## NAVBAR: Body background color =', bgColor);
  }, []);
  ...
  return (
    <>
      <nav
        className="sticky top-0 z-50 w-full h-14 border-b bg-white shadow-sm flex items-center backdrop-blur supports-[backdrop-filter]:bg-background/60"
