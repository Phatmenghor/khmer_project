      ...
      {loading.summary || loading.customerStats ? (
        ...
        <>
          ...
          <KpiCard
            ...
            icon={<ShoppingCart className="h-3.5 w-3.5 text-sky-600" />}
            iconBg="bg-sky-100 dark:bg-sky-950/40"
          />
          <KpiCard
            title="Avg Order Value"
            value={formatCurrency(summary?.avgOrderValue ?? 0)}
            icon={<ArrowUpRight className="h-3.5 w-3.5 text-violet-600" />}
          ...
          <KpiCard
            ...
            icon={<Bell className="h-3.5 w-3.5 text-rose-600" />}
