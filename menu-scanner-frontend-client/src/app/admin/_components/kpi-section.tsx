      ...
      {loading.summary || loading.customerStats ? (
        ...
        <>
          ...
          <KpiCard
            ...
            icon={<ShoppingCart className="h-3 w-3 text-sky-600" />}
            iconBg="bg-sky-100 dark:bg-sky-950/40"
          />
          <KpiCard
            title="Avg Order Value"
            value={formatCurrency(summary?.avgOrderValue ?? 0)}
            icon={<ArrowUpRight className="h-3 w-3 text-violet-600" />}
          ...
          <KpiCard
            ...
            icon={<RotateCcw className="h-3 w-3 text-emerald-600" />}
          ...
          <KpiCard
            ...
            icon={<Bell className="h-3 w-3 text-rose-600" />}
